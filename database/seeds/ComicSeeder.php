    ...
    public function run()
    {
        $comics = [
            ...
            foreach($comics as $comic){
                ...
                $myComic->description = $comic['description'];
                $myComic->thumb = $comic['thumb'];
                $myComic->price = $comic['description'];
                $myComic->series = $comic['series'];
                $myComic->sale_date = $comic['sale_date'];
                $myComic->type = $comic['type'];
                $myComic->save();
            }
    }
}
